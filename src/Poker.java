...
public class Poker {
    ...
    private void takeTurn() {
        cardsSelected = -1;
        do {
            System.out.println("How many cards would you like to switch? (Q: 1-3)");
            cardsSelected = in.nextInt();
        } while (cardsSelected <= -1 || cardsSelected > 3);
        for (int k = 0; k < cardsSelected; k++) {
            do {
                System.out.println("Choose the number of the card you would like to remove (First card has the number of 0)");
                remove = in.nextInt();
    ...
    private void endRound() {
        ...
        String answer = "";
        do {
            System.out.println("Would you like to end the game here or continue playing?(Type end to end the game or continue to continue playing the game)");
